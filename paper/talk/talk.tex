...
\begin{frame}{Bounding mixed powers $\pure{x^ky^l}$}
	\begin{itemize}
		\item Same goal as before: keep the bound \emph{linear} in the
		      variables $\pure{x^my^n}$ depends on
		\item Linearize $x^m$ via the secant bound; treat $y^n$ as a
		      constant coefficient
		\item e.g.
		      \[
			      x\geq 0\land y\geq 5\Rightarrow\pure{x^3y^2}\geq 25\,\pure{x^3}
		      \]
