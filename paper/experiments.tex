...
congruence.
All three configurations include the secant-based axioms of \Cref{sec:axioms};
the frontier strategy (\Cref{sec:algorithm}) is an orthogonal tangent-plane
instantiation heuristic adopted from~\cite{cimatti2017tacas}.
...
Since MathSAT5 implements the incremental linearization approach of Cimatti et
al.~\cite{cimatti2018sat} (cf.\ \Cref{sec:comparison}), the comparison with
MathSAT5 also serves as an experimental comparison with that work.
